...
export class ShowDepComponent implements OnInit {
  ...
  FilterFn(){
    ...
    this.DepartmentList = this.DepartmentListWithoutFiler.filter(function (el:any) {
  ...
  sortResult(prop:any, asc:any){
    this.DepartmentList = this.DepartmentListWithoutFiler.sort(function(a:any,b:any){
      if(asc){
